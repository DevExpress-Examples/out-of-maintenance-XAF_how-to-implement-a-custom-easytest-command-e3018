...
Namespace AdditionalCommands.Web
    Partial Public Class AdditionalCommandsAspNetApplication
        Inherits WebApplication

        Private module1 As DevExpress.ExpressApp.SystemModule.SystemModule
        Private module2 As DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule
        Private module3 As AdditionalCommands.Module.AdditionalCommandsModule
        Private module4 As AdditionalCommands.Module.Web.AdditionalCommandsAspNetModule
        ...
        End Sub
        Private Sub AdditionalCommandsAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
#If EASYTEST Then
            e.Updater.Update()
            e.Handled = True
#Else
...
#End If
        ...
        Private Sub InitializeComponent()
            ...
            Me.module3 = New AdditionalCommands.Module.AdditionalCommandsModule()
            Me.module4 = New AdditionalCommands.Module.Web.AdditionalCommandsAspNetModule()
            ...
            ' sqlConnection1
            ' 
            Me.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=AdditionalCommands;Integrated Security=SSPI;Pooling=false"
            Me.sqlConnection1.FireInfoMessageEventOnUserErrors = False
            ' 
            ' AdditionalCommandsAspNetApplication
            ' 
            Me.ApplicationName = "AdditionalCommands"
...
'            Me.DatabaseVersionMismatch += New System.EventHandler(Of DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)(Me.AdditionalCommandsAspNetApplication_DatabaseVersionMismatch)
