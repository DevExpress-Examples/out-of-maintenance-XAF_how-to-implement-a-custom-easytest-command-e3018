...
Namespace AdditionalCommands.Win
	Partial Public Class AdditionalCommandsWindowsFormsApplication
		...
		End Sub
		Private Sub AdditionalCommandsWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
#If EASYTEST Then
			e.Updater.Update()
			e.Handled = True
#Else
